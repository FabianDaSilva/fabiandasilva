# ¡Hola! Soy Fabian Da Silva 👋

### 🚀 Desarrollador FullStack | Estudiante de Lic. en Sistemas de Información de las Organizaciones (FCE - UBA)

Soy un desarrollador enfocado en crear soluciones digitales que aporten valor real a las organizaciones. Mi formación en la **Universidad de Buenos Aires** me permite tener una visión integral: desde la arquitectura técnica hasta la optimización de procesos y experiencia de usuario.

- 🎓 **Educación:** Licenciatura en Sistemas de Información (FCE - UBA)
- 📍 **Ubicación:** Buenos Aires, Argentina
- 💡 **Intereses:** Arquitectura de Software, Análisis de Sistemas y UI/UX.
